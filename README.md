...
By unraveling these mechanisms, one can try to answer fundamental questions in neuroscience: How can cognitive function emerge from brain dynamics? Which interactions or non-interactions are responsible for a given behavior? By linking experimental data and theory, new light has been shed on brain function, providing valuable insights into neurological disorders and opening doors for new clinical applications. In this study, different models of brain networks will be compared to empirical data in order to better understand and predict how such a complex system behaves.
